# SWAT+ NetCDF Converter (Python)

Part of the [SWAT+ NetCDF Converter](../README.md) project.

This directory contains Python tools for converting SWAT+ weather data to NetCDF format, designed to work with the NetCDF-supported version of SWAT+.
